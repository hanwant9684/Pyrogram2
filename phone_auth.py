...
class PhoneAuthHandler:
    ...
    async def send_otp(self, user_id: int, phone_number: str):
        ...
        try:
            ...
            # Use temporary client for phone authentication
            client = Client(
    ...
    async def verify_otp(self, user_id: int, otp_code: str):
        ...
        try:
            ...
            # Sign in with phone code and hash - IMPORTANT: phone_code_hash MUST come before phone_code!
    ...
    async def _cleanup_stale_sessions(self):
        ...
        Each pending session holds a Pyrogram Client (~60-70MB), so this is critical for constrained environments
        """
        while True:
            try:
